...
import (
	...
	"github.com/tayebehbahreini/admission-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b0fe59e8.x-k8s.io",
	...
	/*
	   	...
	   	err = ctrl.Watch(&source.Informer{Informer: generatedInformers.Batch().V1().Jobs()},&handler.EnqueueRequestForObject{},
	   )
	   	if err != nil {
